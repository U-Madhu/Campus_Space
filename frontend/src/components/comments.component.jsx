...
let total_parent_comments = activity.total_parent_comments || 0;
   ...
   const loadMoreComments=async()=>{
        ...
        let newCommentsArr= await fetchComments({skip:totalParentCommentLoaded,blog_id:_id,setParentCommentCountFun:setTotalParentCommentLoaded,comment_array:commentsArr})
