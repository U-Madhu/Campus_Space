...
const CommentField=({action,index=undefined,replyingTo=undefined,setReplying=false})=>{
    ...
    const handleComment=()=>{
        ...
        .then(({data})=>{
           ...
           setBlog({...blog,comments:{...comments,results:newCommentArr},activity:{...activity,total_comments:total_comments+1,total_parent_comments:total_parent_comments+parentCommentIncrementalval}})


            setTotalParentCommentLoaded(preVal=>preVal+parentCommentIncrementalval)
