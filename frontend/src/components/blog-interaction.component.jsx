         ...
         <div className="flex gap-6 justify-between">
                ...
                <div className="flex gap-3 items-center">
                    ...
                    <button
                        ...
                        // FIXED: Corrected comment button background classes to not check islikedByUser
                ...
                <div className="flex gap-6 items-center">

                    {
                        ...
                        <Link to={`/editor/${blog_id}`} className="underline hover:text-purple">Edit</Link>:""
                            ...
                            <Link to={`https://x.com/intent/tweet?text=Read ${title}&url=${location.href}`}> <i className="fi fi-rr-brands-alt-square text-xl hover:text-twitter"/> </Link>
